...
public class King extends Pieces {
    ...
    public Image getImage() {
        ...
        if (isWhite) {
            return new 
                ImageIcon(System.getProperty("user.dir") + "/Images/Pieces/WhitePieces/WhiteKing.png").getImage();
        }
        else {
            return new 
                ImageIcon(System.getProperty("user.dir") + "/Images/Pieces/BlackPieces/BlackKing.png").getImage();
        }
    }
}
